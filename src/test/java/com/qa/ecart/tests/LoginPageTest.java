...
public class LoginPageTest extends baseTestclass {
    ...
    public void getloginHeader() {
        ...
        Assert.assertTrue(header); // fixed assertion
    }

    @Test
    public void loginTest() {
        AccountPage accPage = loginPage.justLogin(prop.getProperty("username"), prop.getProperty("password"));
        Assert.assertEquals(accPage.getAccountPageTitle(), AppConstants.ACCOUNT_PAGE_TITLE); // fixed comparison
    }
}
